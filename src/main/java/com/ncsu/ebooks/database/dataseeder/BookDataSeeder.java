...
public class BookDataSeeder {
    public static void seedTables(Connection conn) throws SQLException {
        try (Statement statement = conn.createStatement()) {
            String seedETBTable = "INSERT INTO ETextBook (eTextBookID, title)" +
                    "VALUES (101, \"Database Management Systems\")," +
                    "(102, \"Fundamentals of Software Engineering\")," +
                    "(103, \"Fundamentals of Machine Learning\");";

            statement.executeUpdate(seedETBTable);
            
            String seedChapterTable = "INSERT INTO Chapter (chapterNumber, title, eTextBookID, hidden)" +
            ...
            statement.executeUpdate(seedChapterTable);
            
            String seedSectionTable = "INSERT INTO Section (sectionNumber, chapterID, title, hidden)" +
            ...
            statement.executeUpdate(seedSectionTable);

            String seedContentBlockTable = "INSERT INTO ContentBlock (sectionID, image, textBlock, hidden)" +
            "VALUES (1, NULL, \"A Database Management System (DBMS) is software that enables users to efficiently create, manage, and manipulate databases. It serves as an interface between the database and end users, ensuring data is stored securely, retrieved accurately, and maintained consistently. Key features of a DBMS include data organization, transaction management, and support for multiple users accessng data concurrently.\", 0)," +
            "(2, NULL, NULL, 0)," +
            "(3, NULL, \"DBMS systems provide structured storage and ensure that data is accessible through queries using languages like SQL. They handle critical tasks such as maintaining data integrity, enforcing security protocols, and optimizing data retrieval, making them essential for both small-scale and enterprise-level applications. Examples of popular DBMS include MySQL, Oracle, and PostgreSQL.\",  0)," +
            "(4, \"sample.png\", NULL, 0)," +
            "(5, NULL, \"The history of software engineering dates back to the 1960s, when the \'software crisis\' highlighted the need for structured approaches to software development due to rising complexity and project failures. Over time, methodologies such as Waterfall, Agile, and DevOps evolved, transforming software engineering into a disciplined, iterative process that emphasizes efficiency, collaboration, and adaptability.\", 0)," +
            "(6, NULL, NULL, 0)," +
            "(7, NULL, \"The Software Development Life Cycle (SDLC) consists of key phases including requirements gathering, design, development, testing, deployment, and maintenance. Each phase plays a crucial role in ensuring that software is built systematically, with feedback and revisions incorporated at each step to deliver a high- quality product.\", 0)," +
            "(8, \"sample2.png\", NULL, 0)," +
            "(9, NULL, \"Machine learning is a subset of artificial intelligence that enables systems to learn from data, identify patterns, and make decisions with minimal human intervention. By training algorithms on vast datasets, machine learning models can improve their accuracy over time, driving advancements in fields like healthcare, finance, and autonomous systems.\", 0)," +
            "(10, NULL, NULL, 0);";
            ...
            String seedAnswerSetTable = "INSERT INTO AnswerSet (activityID, answerOption, correct, explanation)" +
            ...
            statement.executeUpdate(seedAnswerSetTable);

            System.out.println("Seeded ETextbook Tables");
        } catch (SQLException e) {
            log.error("An error occurred in Book data seeder :: seedTables", e);
        }
    }
}
